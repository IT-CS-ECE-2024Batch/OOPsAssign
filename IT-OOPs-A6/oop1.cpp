...
/* |\     /|     @author: umgbhalla
	 ...
	 (_______) */
/*
	 Create a class called Time for performing arithmetic with Time. Write a program to test your structure.
	 Format for Time is hh(hours):mm(minutes):ss(seconds). Use integer variables to define hours, minutes and seconds as private data member of the class.  
...
ostream& operator<<(ostream& os, const Time& t) {
	os << setw(2) << setfill('0') << t.hour << ":" << setw(2) <<\
		setfill('0') << t.minute << ":" << setw(2) << setfill('0') << t.second ;
	return os;
}
...
{
	Time t1,t2;  
	cout<<"time object 1 in space seperated form {for eg: 12 10 39}\n";
	cin >>t1;
cout<<"t1 ==> "<<t1<<"\n";
	cout<<"time object 2 in space seperated form {for eg: 12 10 39}\n";
	cin >>t2;
	cout<<"t2 ==> "<<t2<<"\n";
	...
	cout << "\n Name: Umang Bhalla \n Scholar No: 20U03031 Date : 24 Sep 2021  " << endl;
	return 0;
}
